...
rebuild_firmware() {
    ...
    misc+=" luci-app-temp-status luci-app-alpha-config luci-app-cpufreq luci-app-droidnet luci-app-eqosplus /
    luci-app-rakitanmanager luci-app-syscontrol luci-app-tinyfm luci-theme-alk luci-theme-alpha ookla-speedtest"
